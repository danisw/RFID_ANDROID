...
public class ListActivity extends AppCompatActivity {
    ...
    public void onContentChanged() {
        ...
        heroImageView = findViewById(R.id.heroImageView2);
        // stickyView = (TextView) findViewById(R.id.stickyView);

        // Get the widget reference from XML layout
        mCLayout = (CoordinatorLayout) findViewById(R.id.coordinator_layout2);
        mToolbar = (Toolbar) findViewById(R.id.toolbar2);
        mCToolbarLayout = (CollapsingToolbarLayout) findViewById(R.id.collapsing_toolbar_layout2);

        // Set a title for collapsing toolbar layout
        mCToolbarLayout.setTitleEnabled(true);
        mCToolbarLayout.setTitle("Scan Activity");
        ...
        btn_scan=findViewById(R.id.menu_scan);
